...
class ShapeDetailAdapter : RecyclerView.Adapter<ShapeDetailAdapter.DataViewHolder>() {

    private var pokemons: ArrayList<PokemonSpeciesListShape> = ArrayList()
    ...
    fun setOnItemClickListenerUrlShape(listener: (String) -> Unit) {
        onItemClickListenerUrl = listener
    }

    fun addPokemons(pokemonsFromFragment: List<PokemonSpeciesListShape>) {
        this.pokemons.apply {
            clear()
