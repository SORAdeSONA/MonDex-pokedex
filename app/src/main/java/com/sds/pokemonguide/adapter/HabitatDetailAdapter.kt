...
import com.sds.pokemonguide.model.PokemonSpeciesListHabitat
import com.sds.pokemonguide.model.PokemonSpeciesModelEggGroup

class HabitatDetailAdapter : RecyclerView.Adapter<HabitatDetailAdapter.DataViewHolder>() {

    private var pokemons: ArrayList<PokemonSpeciesListHabitat> = ArrayList()
    ...
    fun addPokemons(pokemonsFromFragment: List<PokemonSpeciesListHabitat>) {
        this.pokemons.apply {
            clear()
